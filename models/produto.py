...
class Produto(db.Model):    
    ...
    def serialize(self):
        ...
        'porcentagem':self.porcentagem,'preco_custo':self.preco_custo,'preco_venda':self.preco_venda,'foto':self.foto,'marca_id':self.marca_id,'animal_id':self.animal_id,'tamanho_id':self.tamanho_id}
